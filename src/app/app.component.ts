...
import { SkillsSectionComponent } from '../skills/skills.component';
import { SpeakingComponent } from '../speakings/speakings.component';
...
@Component({
  ...
  imports: [RouterOutlet, HomeComponent, AboutComponent,
    ...
    ChannelOverviewComponent, SkillsSectionComponent,
    BlogsComponent, TestmonialsComponent, ContactComponent, CallToActionComponent, NavbarComponent, SkillsSectionComponent, SpeakingComponent],
